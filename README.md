...
Не нужно использовать читы в виде Catboost, Xgboost, PyTorch, TF и т.п. Машинка только из scikit-learn, остальные библиотеки по вкусу (но не забывайте в преамбуле писать закоментированную команду установки не стандартых библиотек).
